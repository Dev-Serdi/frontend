...
import { createUbicacion } from "../../services/UbicacionService"; // Assuming this service function exists
...
export const AddUbicacion = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage = err.response?.data?.message || "Error al crear la ubicacion. Por favor, inténtelo de nuevo.";
