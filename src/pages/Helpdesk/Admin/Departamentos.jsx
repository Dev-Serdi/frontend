            ...
            <>
              ...
              {currentItems.length > 0 ? (
                currentItems.map((departamento) => (
                  <Link
                    to={`/admin/helpdesk/departamentos/detalle/${departamento.id}`}
                    key={departamento.id}
                    className=" text-decoration-none grid grid-cols-12 gap-4 items-center px-4 py-2 border-b border-gray-100 hover:bg-gray-50 transition-colors"
                  >
                    {" "}
                    ...
                    <div className="col-span-4 flex justify-center">
                      <button                        
                        ...
                        onClick={(e) => {
                          e.preventDefault();
                          navigate(
                            `/admin/helpdesk/departamentos/editar/${departamento.id}`
                          );
                        }}
                        title="Editar"
                      >
