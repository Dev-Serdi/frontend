                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {tickets.map((ticket, index) => (
                    ...
                    >
                      ...
                      <td className="p-4">
                        <div className="text-sm text-gray-900 font-semibold line-clamp-1 w-40" > 
                          {ticket.tema}
                        </div>
                      </td>
                      <td className="p-4 whitespace-nowrap">
                      ...
                      <td className="p-4 whitespace-nowrap">
                        <span className="text-sm text-gray-900 font-semibold line-clamp-1 w-40">
                      ...
                      <td className="p-4 whitespace-nowrap text-sm text-gray-500 line-clamp-1 w-41">
