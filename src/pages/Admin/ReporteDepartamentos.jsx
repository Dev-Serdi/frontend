      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="p-4 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center">
          <h2 className="text-2xl font-bold text-gray-800">
            Reporte de Métricas por Departamento
          </h2>
          <button
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {metricas.map((departamento, index) => {
                  const eficiencia =
                    departamento.totalTickets > 0
                      ? (departamento.ticketsCerrados /
                          departamento.totalTickets) *
                        100
                      : 0;
                    ...
                    >
                        ...
                        <div className="flex items-center">
                          <div className="flex-shrink-0 h-10 w-10 bg-green-100 rounded-full flex items-center justify-center">
                            <span className="text-green-800 font-bold">
                              {departamento.groupName.charAt(0)}
                            </span>
                          </div>
                          <div className="ml-4">
                      ...
                      <td className=" p-4 whitespace-nowrap">
                        <span className="p-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-900">
                          {departamento?.ticketsSinRespuesta || 0}
                        </span>
                      </td>
                      <td className=" p-4 whitespace-nowrap">
