    ...
    <div className="home-container">
      ...
      <div className="grid-layout">
        ...
        <div className="grid-item">
          <Link to={"/knowledge/sites"} className="text-decoration-none">
            <h2>Mis Sitios</h2>
          </Link>
              ...
              <ul className="list-unstyled">
                {sitiosFiltrados.map((sitio) => (
                  <li
                    ...
                    onClick={() => navigate(`/knowledge/sites/${sitio.id}`)}
                  >
        ...
        <div className="grid-item">
          <Link to={"/knowledge/task"} className="text-decoration-none">
        ...
        <div className="grid-item">
          <Link to={"/knowledge/myfile"} className="text-decoration-none">
            <h2>Mis Archivos</h2>
          </Link>
          <div className="filter-container">
            <select className="filter small-filter">
